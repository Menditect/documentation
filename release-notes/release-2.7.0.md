...
| __Release actions__   | Test management apps using MTA's [Public API](../mta/api#post-execute-testconfiguration) to execute a Test Configuration, have to provide a "Coverage" parameter in the body. Check the reference guide for more information.                                                                                                                                                                                                                                                          |
<br/>
