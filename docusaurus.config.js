    ...
    [
      ...
      ({
        ...
        versionedLinks: [
          ...
          { id: 'application-instance', content: 'application-instance.md', versions: ['2.0.0'] },
          ...
          { id: 'test-setting', content: 'test-setting.md', versions: ['2.0.0'] },
          { id: 'test-run', content: 'test-run.md', versions: 'ALL' },
          { id: 'assert-attribute', content: 'Assert/assert-attribute.md', versions: ['2.0.0'] },
          { id: 'assert-microflow-output', content: 'Assert/assert-microflow-output.md', versions: ['2.0.0'] },
          { id: 'assert-object-count', content: 'Assert/assert-object-count.md', versions: ['2.0.0'] },
  ...
  themeConfig:
    ...
    ({
      ...
      prism: {
        ...
        additionalLanguages: ['java', 'json', 'ps1'],
      },
    }),
};
