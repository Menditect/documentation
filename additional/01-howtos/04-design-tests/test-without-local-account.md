...
- Use a microflow to generate a random password so you can use it to login a [Frontend test](design-frontend-test-with-mta), during the execution of the test.
