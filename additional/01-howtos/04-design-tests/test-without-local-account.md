...
- Use a microflow to generate a random password so you can use it to login a [Frontend test](frontend-test-structure-in-mta), during the execution of the test.
