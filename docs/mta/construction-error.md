...
A Construction Error means that [Teststep](Teststep/) data is missing or not correctly structured. A construction error needs to be solved before the respective test can be executed.
