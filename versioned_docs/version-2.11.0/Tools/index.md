...
The [MTA Plugin](tools/mta-plugin) module is **required** to be imported in the Mendix App under test.

If you want to use the **Frontend Testing** features of MTA, you need to import these modules as well:
